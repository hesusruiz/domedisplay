...
// front/src/app.js
var myerror2 = storage.myerror;
var mylog2 = storage.mylog;
  ...
  for (let [name, classInstance] of pageNameToClass2) {
    ...
    if (name !== pageName && classInstance.exit) {
      try {
        ...
        myerror2(`error calling exit() on ${name}: ${error.name}`);
      }
    }
  }
